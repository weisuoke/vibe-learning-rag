...
> **与[相关概念]的区别**：[对比说明]
>
> **在实际工作中的应用**：[举例说明在 RAG/LLM 应用中的实践]
...
**模板：**
```markdown
**[知识点]是[定义]，[核心特征]，在 RAG 开发中[具体应用/价值]。**
```
...
**示例：**
```
atom/L1_NLP基础/01_BPE分词原理.md
atom/L1_NLP基础/02_Embedding原理与选型.md
atom/L2_LLM核心/01_Transformer直觉理解.md
atom/L3_RAG核心流程/01_文档加载与解析.md
```
...
│   ├── k.md                          # 知识点列表
│   ├── 01_BPE分词原理.md
│   ├── 02_Embedding原理与选型.md
│   └── 03_语义相似度.md
├── L2_LLM核心/
│   ├── k.md
│   ├── 01_Transformer直觉理解.md
│   ├── 02_大模型API调用.md
│   ├── 03_Token与Context_Window.md
│   ├── 04_Prompt_Engineering基础.md
│   └── 05_Prompt_Engineering进阶.md
├── L3_RAG核心流程/
│   ├── k.md
│   ├── 01_文档加载与解析.md
│   ├── 02_文本分块Chunking.md
...
- [ ] 每个部分都联系了 RAG 开发应用
- [ ] 强调了实际 LLM 应用场景
- [ ] 说明了为什么 RAG 开发需要这个知识点
- [ ] 提供了实际应用场景（文档问答/知识库检索/智能客服/内容生成）
...
3. **读取知识点列表** (`atom/[层级]/k.md`)
4. **确认目标知识点**（第几个）
5. **按规范生成内容**（10个维度）
6. **质量检查**（使用检查清单）
7. **保存文件**（`atom/[层级]/[编号]_[知识点].md`）

### 提示词模板

```
根据 @CLAUDE.md 的规范，为 @atom/[层级]/k.md 中的第[N]个知识点 "[知识点名称]" 生成一个完整的学习文档。
